...
import { setTotalResults, setVideos, setQuery, IVideo, setIsModalVisible } from '../state/search-reducer';
        ...
        <main className="home-results">
            <div className="home-results__container">
                <SearchModal title='Сохранить запрос'
                    ...
                    <Form.Item initialValue="rating" label='Сортировать' name='sortBy'>
                        <Select size="large">
